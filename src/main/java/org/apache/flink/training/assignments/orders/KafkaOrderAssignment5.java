...
import org.apache.flink.training.assignments.functions.MyProcessFunction;
...
public class KafkaOrderAssignment5 extends ExerciseBase {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaOrderAssignment5.class);
