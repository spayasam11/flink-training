 ...
 */
public class FlatOrderWatermarkGenerator implements AssignerWithPeriodicWatermarks<FlatSymbolOrder> {
    ...
    @Override
    public long extractTimestamp(FlatSymbolOrder element, long previousElementTimestamp) {
